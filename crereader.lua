...
-- ====================================================================
-- NuPogodi, 16.08.12 --> adjust some commands inherited from UniReader
-- and remove manual cropping (not crengine-related)
-- ====================================================================
...
-- ======================== end of last changes ========================
	...
	self.commands:add(KEY_F, MOD_ALT, "F",
		--[[ NuPogodi, 18.08.12: 
		1.	Changed a description to be shown in helppage
		2.	Added message to user
		2.	Improved a method to restore position ]]
